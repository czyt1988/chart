...
QString QwtPlotPropertySetDialog::axisString(QwtPlot::Axis axis) const
{
    switch(axis)
    {
        case QwtPlot::xBottom:return QStringLiteral("x底");
        case QwtPlot::xTop:return QStringLiteral("x顶");
        case QwtPlot::yLeft:return QStringLiteral("y左");
        case QwtPlot::yRight:return QStringLiteral("y右");
    }
...
void QwtPlotPropertySetDialog::addCurveSet(ChartWave_qwt* plot)
{
